...
<div class="register-box">
    <div class="register-logo">
        <a href="../../index2.html"><b>百程</b>知识库</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="姓名" name="name" value="{{ old('name') }}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> 我同意 <a href="#">知识库条款</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ route('login') }}" class="text-center">已有账号，请登录</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
